...
House::House(std::string name, int cost, int sizeX, int sizeY, double hapinessEffect, int populationEffect, int moneyPerturn, int b_X, int b_Y) 
: Building(name, cost, sizeX, sizeY, hapinessEffect, populationEffect, moneyPerturn, b_X, b_Y) {}; 

std::string House::GetFullName() {
    return "House " + GetName();
}

void House::GetInfo(int numberOfBuilding) {
    std::cout
